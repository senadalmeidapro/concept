...
<head>
    ...
    <title>Modifier le Score - Reflex Master</title>
    ...
    <div class="max-w-md mx-auto px-4 py-8">
        <div class="bg-white rounded-xl shadow-lg p-8">
            <div class="text-center mb-6">
                ...
                <h1 class="text-2xl font-bold text-gray-800">Modifier le Score</h1>
                <p class="text-gray-600 mt-2">Mettez à jour les informations du score</p>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="difficulty" id="difficulty" required
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            <option value="easy" {{ $game->difficulty == 'easy' ? 'selected' : '' }}>Facile</option>
                            <option value="medium" {{ $game->difficulty == 'medium' ? 'selected' : '' }}>Moyen</option>
                            <option value="hard" {{ $game->difficulty == 'hard' ? 'selected' : '' }}>Difficile</option>
                        </select>
                    </div>
